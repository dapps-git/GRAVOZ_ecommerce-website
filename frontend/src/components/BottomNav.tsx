...
export default function BottomNav() {
  ...
  // Exclude bottom navigation bar completely from invoices, auth screens, and checkout
  if (
    !pathname ||
  ...
  const isAccount = pathname.startsWith('/profile') || pathname.startsWith('/account');
