...
async function seed() {
  ...
  // 3. Seed Products (Each with 3 photos & alt text requirement satisfied!)
  ...
  const sampleProducts = [
    ...
    },
    {
      ...
      price: 45.00,
      discountPrice: 35.00,
      stock: 3, // Low stock for testing low stock warning!
  ...
  await db.collection('testimonials').insertMany([
    {
      ...
      rating: 5,
      comment: 'GRAVOZ Men & Women Apex shoes are by far the best cushioned running shoes I have owned. Outstanding grip!',
      isApproved: true,
      createdAt: new Date(),
      updatedAt: new Date(),
    },
    {
      ...
      rating: 5,
      comment: 'The Baby First-Step shoes are lightweight and extremely supportive for my 14-month-old daughter.',
      isApproved: true,
      createdAt: new Date(),
      updatedAt: new Date(),
    },
